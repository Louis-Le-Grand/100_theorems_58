...
## Assignment
In the paper, one should put the factorial (n!) and the binomial coefficients
right after section 20 "Exponentiation".
Then the theorem itself (the number of k-element subsets of a set with n elements
is (n over k) should be behind section 28 "Number of Subsets of a Set"
...
(n+1 over k) = (n over k) + (n over (k-1)).
